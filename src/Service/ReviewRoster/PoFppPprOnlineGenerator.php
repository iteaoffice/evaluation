...
final class PoFppPprOnlineGenerator extends PoFppPprGenerator
{
    ...
    public function generate2(): RosterData
    {
        $logger = new Logger();
        ...
        $logger->log(__LINE__, sprintf('Projects: %d, Reviewers: %d', $projectCount, $reviewerCount));
